...
public class MyButton1 extends Button {
    ...
    public MyButton1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        Log.e("MyButton1", "dispatchTouchEvent：" + event.getAction());
        return super.dispatchTouchEvent(event);
    }

    @Override
    public boolean onTouchEvent(MotionEvent event) {
        Log.e("MyButton1", "onTouchEvent：" + event.getAction());
